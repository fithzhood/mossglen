...
var MOSSGLEN_DATA = {
  ...
  items: {
    ...
    reed:       { name: 'Reed',        bloom: 2, tags: ['water', 'soft'] },
  ...
  /* Second ways of saying thank you. Wishes cycle for ever, so a villager who
     has only one line per gift ends up repeating it every few days — which is
     exactly what the fourteen-line sample kept catching. */
  thanksAgain: {
    pim: {
      pebble: "Another one. I've got a use for it. I've got a use for most things, which is how the shelf got like that.",
      pinecone: "Two of them now. I'm not starting a collection. That is how collections start, and I am not.",
      glassbead: "Still can't get used to them. I hold it up to the window like an idiot every single time."
    },
    marla: {
      reed: "You keep bringing me the pond a bit at a time. I'm in no hurry to have all of it.",
      snailshell: "Another empty one. They're never quite the same shape. That's the whole interest of them.",
      feather: "You've got an eye for the ones worth picking up. Not everybody has. Most people just see the ground."
    },
    bodkin: {
      mushroom: "ANOTHER. Right. This one goes somewhere different so I can compare. This is science now.",
      acorn: "In it goes with the other one. In ninety years there'll be two trees and nobody will know why they're that far apart.",
      glassbead: "I've got TWO. Two! I'm going to put one somewhere safe and then spend a week not finding it."
    }
  },
  ...
  homeSlots: [
    ...
    { id: 'shelfL',  name: 'left shelf',   x: 32,  y: 100 },
    { id: 'shelfR',  name: 'right shelf',  x: 142, y: 100 },
    { id: 'table',   name: 'table',        x: 109, y: 199 },
    { id: 'stool',   name: 'stool',        x: 103, y: 255 },
    { id: 'crate',   name: 'crate',        x: 30,  y: 243 }
  ],

  /* How a roomful of things reads from the doorway. A villager who can only
     comment on one object at a time is reacting to an inventory; a villager
     who can tell that your house has gone all soft, or all tidy, is reacting
     to a decision you made. Moods are read off the tags on placed items. */
  roomMoods: {
    tidy: {
      name: 'orderly',
      pim: "Your place has gone deliberate. Everything squared off and put where it goes. I noticed from the path and I thought: yes. Good.",
      marla: "It's all lined up in there. I couldn't live like it, but I like knowing somebody does.",
      bodkin: "Everything in your house is at RIGHT ANGLES. I bumped one once and put it back and I'm still thinking about whether I got it right."
    },
    soft: {
      name: 'soft',
      pim: "Moss, feathers, that sort of thing. It's gone soft in there. Sensible for winter, actually — I'm not being rude about it.",
      marla: "Everything in your house is the kind of thing that doesn't make a sound when you put it down. I think about that more than I should.",
      bodkin: "Your house has gone all SOFT. I'd like to lie down in it. I won't! But I'd like to."
    },
    odd: {
      name: 'strange',
      pim: "There's a lot of unusual objects in there now. I'm not going to ask what they're for. I have decided not to ask.",
      marla: "Odd things, kept on purpose. A house full of those is a house that's been paying attention.",
      bodkin: "YOUR HOUSE IS FULL OF STRANGE THINGS. This is the best news I've had all week and I've had two other pieces of news."
    },
    water: {
      name: 'like the pond',
      pim: "Half the pond's in your house. Dried out, mind. I checked. Not dripping. I did check.",
      marla: "You've brought the water indoors. Shells and reeds and grey feathers. It smells right in there, and I don't mean damp.",
      bodkin: "Everything in your house came out of the wet. I can tell. Things from the wet feel different and I'm right about this."
    },
    full: {
      name: 'well-furnished',
      pim: "There's not a spare surface left in there. That's a house now. That's not a room somebody sleeps in, that's a house.",
      marla: "Every place a thing could sit has a thing sitting on it. It took you a while. It should have.",
      bodkin: "I counted six! SIX things! I counted them through the window and then I counted them again to be sure and I got six again."
    }
  },
      ...
      lines: {
        ...
        idle: {
          morning: [
            ...
            "Frost on the well rim. It'll be gone by nine and I'll be the only one who saw it.",
            "I have been awake long enough to have opinions and not long enough to say them well.",
            "Somebody's been at the berry bush before me. Small feet. I'm not investigating."
          ],
          day: [
            ...
            "There's an order to the day and I've never written it down, which I think is the point of it.",
            "I'm no good at doing nothing. I've been practising. I've got as far as sitting.",
            "You find things. I keep track of things. Between us the village is more or less accounted for."
          ],
          evening: [
            ...
            "The stump throws a shadow the whole width of the clearing at this hour. Every evening. Still gets me.",
            "I've eaten. I've sat down. There is nothing after this and that's the good part.",
            "Somebody laughed by the pond about an hour ago. I don't need to know why. It was just good to hear."
          ],
          night: [
            ...
            "It's the one time the whole place agrees about something, and what it agrees about is being quiet.",
            "I check the well last thing. Not for any reason. It's just the last thing I do.",
            "You get to an hour where nothing more is going to happen today, and it's a relief, not a disappointment."
          ]
        }
      }
    },
      ...
      lines: {
        ...
        idle: {
          morning: [
            ...
            "Everything's got water on it and none of it fell as rain. I find that a generous arrangement.",
            "I've been watching one particular reed since before it was light. No, I couldn't tell you which.",
            "Morning takes about forty minutes to properly arrive. People miss it by getting up too late or too early."
          ],
          day: [
            ...
            "Warm on one side, cold on the other. That's the whole of the afternoon, described.",
            "I have stood in this spot for long enough that the frogs have stopped counting me as an event.",
            "You do a great deal. I've noticed. I hope somebody's told you it shows."
          ],
          evening: [
            ...
            "The colour goes out of things from the bottom up. Nobody ever believes me until they watch for it.",
            "This is when the pond stops being water and starts being a surface. Different thing entirely.",
            "I like a day that ends without having been about anything."
          ],
          night: [
            ...
            "Cold comes up out of the ground at night, not down from the sky. Took me years to work that out.",
            "I don't mind the dark. I mind being hurried, and the dark has never once hurried me.",
            "Everything that was loud has stopped, and what's left was there the whole time."
          ]
        }
      }
    },
      ...
      lines: {
        ...
        idle: {
          morning: [
            ...
            "I have already been somewhere and come back and I'm not going to say where.",
            "Worms are up. Worms are always up. Worms have no concept of a lie-in and I admire that.",
            "The ground's soft this morning! Soft ground is FAST ground. I could be anywhere by lunch."
          ],
          day: [
            ...
            "I've dug three holes today and filled in two. The third one is a work in progress and also a hole.",
            "Everyone says 'be careful down there'. Down there is the SAFE bit. Up here is where the sky is.",
            "I can hear you thinking. No I can't. But I can hear you standing, and that's nearly as good."
          ],
          evening: [
            ...
            "The light's gone that colour where even a stone looks like it's had a nice time.",
            "I've stopped for the day. Well. I've stopped for the hour. We'll see.",
            "Something small went past my foot at speed and I've decided to be pleased about it."
          ],
          night: [
            ...
            "Night's the only time the whole village smells like one thing instead of forty.",
            "I don't dream so much as remember tunnels. It's restful. You'd hate it.",
            "There's a particular quiet that means rain tomorrow. This is that quiet. Mark it down."
          ]
        }
      }
    }
